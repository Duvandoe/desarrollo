...
const DeviceRepair = () => {
  ...
  const [showAddModal, setShowAddModal] = useState(false); // Para manejar la visibilidad del modal de añadir
  ...
  const handleAddRepair = (e) => {
    e.preventDefault();
    // Asignar un ID único a la nueva reparación
  ...
  {/* Contenedor del botón de añadir reparación */}
  <div className="add-repair-btn-container">
    <button className="btn-añadir" onClick={() => setShowAddModal(true)}>Añadir Reparación</button>
  </div>
  ...
  <div className="device-cards">
    {devicesInRepair.map((device) => (
      <div className="device-card" key={device.id}>
        ...
        <button className="view-details-btn" onClick={() => openModal(device)}>
    ...
    <div className="modal-overlay">
      <div className="modal-content">
        ...
        <form onSubmit={handleAddRepair}>
          ...
          <button type="submit" className="btn-añadir">Añadir Reparación</button>
          <button type="button" className="modal-close-btn" onClick={() => setShowAddModal(false)}>Cancelar</button>
        </form>
      </div>
    </div>
  )}
